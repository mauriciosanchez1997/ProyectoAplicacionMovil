...
import com.example.webservicesimagealdo.adapter.UsuariosImagenAdapter;
import com.example.webservicesimagealdo.adapter.UsuariosImagenUrlAdapter;
...
public class ConsultaListaUsuarioImagenUrlFragment extends Fragment implements Response.Listener<JSONObject>,Response.ErrorListener{
   ...
   // RequestQueue request;
    ...
    private void cargarWebService() {
        ...
        dialog.setMessage("Consultando usuarios");
        dialog.show();
    ...
    public void onResponse(JSONObject response) {
        ...
        try {
            ...
            for (int i=0;i<json.length();i++){
                ...
                usuario.setDocumento(jsonObject.optInt("id"));
                usuario.setUsuario(jsonObject.optString("usuario"));
                usuario.setNombre(jsonObject.optString("nombre"));
                usuario.setProfesion(jsonObject.optString("apellidos"));
