...
TextView mensaje;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista=inflater.inflate(R.layout.fragment_bienvenida, container, false);
            mensaje=(TextView)vista.findViewById(R.id.etqDatos);
            String Item=getActivity().getIntent().getStringExtra("nombre");
            mensaje.setText(mensaje.getText()+"Su nombre es"+Item);
